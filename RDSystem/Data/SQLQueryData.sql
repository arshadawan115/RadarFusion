...
DECLARE @Callsign NVARCHAR(200) = 'StockholmSelect786';
DECLARE @Latitude0 FLOAT = 59.3293; -- Central Latitude (Stockholm)
DECLARE @Longitude0 FLOAT = 18.0686; -- Central Longitude (Stockholm)
DECLARE @Altitude FLOAT = 112;  -- Altitude can be NULL initially
DECLARE @Velocity FLOAT = 111;  -- Velocity can be NULL initially
...
DECLARE @Radius FLOAT = 65;          -- Radius in kilometers
